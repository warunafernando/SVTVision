...
export const STAGE_ALGORITHM_SCHEMAS: StageAlgorithmSchema[] = [
  {
    ...
    variables: [
      ...
      { key: 'adaptive_thresholding', label: 'Adaptive thresholding', type: 'boolean', default: false },
      { key: 'contrast_normalization', label: 'Contrast normalization', type: 'boolean', default: false },
