...
const FALLBACK_ITEMS: PaletteItem[] = [
  ...
  { id: 'stage_preprocess', type: 'stage', label: 'preprocess_cpu', stage_id: 'preprocess_cpu', ports: { inputs: [{ name: 'frame', type: 'frame' }], outputs: [{ name: 'frame', type: 'frame' }] } },
  { id: 'stage_detect', type: 'stage', label: 'detect_apriltag_cpu', stage_id: 'detect_apriltag_cpu', ports: { inputs: [{ name: 'frame', type: 'frame' }], outputs: [{ name: 'frame', type: 'frame' }, { name: 'detections', type: 'detections' }] } },
